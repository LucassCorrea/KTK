...
class TesteEquil extends StatefulWidget {
  const TesteEquil({Key? key}) : super(key: key);

  @override
  State<TesteEquil> createState() => _TesteEquilState();
}

class _TesteEquilState extends State<TesteEquil> {
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text(
                    'Andar para trás ao longo de uma trave de equilibrio de largura decrescente de 6,0, 4,5 e 3,0 cm',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: const Color(0xFF084769),
