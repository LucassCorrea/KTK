...
class TesteTransf extends StatefulWidget {
  const TesteTransf({Key? key}) : super(key: key);

  @override
  State<TesteTransf> createState() => _TesteTransfState();
}

class _TesteTransfState extends State<TesteTransf> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Routes.CALCULANDO);
                },
                child: Text(
                  'Avançar',
                  style: TextStyle(
